...
const {handleCreateTask, retrieveAllUserTasks, retrievOneUserTask, handleUpdateOneUserTask, handleUpdateTaskStatus, handleAssignToUser, handleDeleteTask, handleRetriveAllTasks, handleFilterUserTaskPerCriteria}= require('../Controller/taskRequest');
...
taskRouter.get('/fiterTaskByStatusDate', verifyToken,decryptToken,restrictToTaskManagerAndWorker,handleFilterUserTaskPerCriteria)
